...
contract SupplyChain is FarmerRole, DistributorRole, RetailerRole, ConsumerRole, Ownable {
  ...
  function buyItem(uint _upc) public payable
    ...
    // Update the appropriate fields - ownerID, distributorID, itemState
      ...
      originFarmerIDPayable.transfer(items[_upc].productPrice);
    // emit the appropriate event
      emit Sold(_upc);
  }
  ...
  function receiveItem(uint _upc, address retailer) public 
    // Call modifier to check if upc has passed previous supply chain stage
    shipped(_upc)
  ...
  function purchaseItem(uint _upc, address consumer) public
    // Call modifier to check if upc has passed previous supply chain stage
    received(_upc)
    // Access Control List enforced by calling Smart Contract / DApp
    onlyConsumer
