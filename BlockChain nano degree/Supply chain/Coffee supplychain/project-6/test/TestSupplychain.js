...
contract("SupplyChain", function (accounts) {
  ...
  it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
    ...
    const harvested = await supplyChain.harvestItem(
      upc,
      originFarmerID,
      originFarmName,
    ...
    assert.equal(harvested.logs[0].event, "Harvested", "Invalid event emitted");
  });
  ...
  it("Testing smart contract function processItem() that allows a farmer to process coffee", async () => {
    ...
    const processed = await supplyChain.processItem(upc);
    ...
    assert.equal(processed.logs[0].event, "Processed", "Invalid event emitted");
  });
  ...
  it("Testing smart contract function packItem() that allows a farmer to pack coffee", async () => {
    ...
    const packed = await supplyChain.packItem(upc);
    ...
    assert.equal(resultBufferOne[1], upc, "Error: Invalid item UPC");
    assert.equal(resultBufferTwo[5], itemState, "Error: Invalid item State");
    assert.equal(packed.logs[0].event, "Packed", "Invalid event emitted");
  });
  ...
  it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
    ...
    const forSale = await supplyChain.sellItem(upc, productPrice);
    ...
    assert.equal(resultBufferTwo[5], itemState, "Error: Invalid item state");
    assert.equal(forSale.logs[0].event, "ForSale", "Invalid event emitted");
  });
  ...
  it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
    ...
    const sold = await supplyChain.buyItem(upc, {
      from: distributorID,
      value: productPrice,
    });
    ...
    assert.equal(sold.logs[0].event, "Sold", "Invalid event emitted");
  });
  ...
  it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async () => {
    ...
    const shipped = await supplyChain.shipItem(upc);
    ...
    assert.equal(shipped.logs[0].event, "Shipped", "Invalid event emitted");
  });
  ...
  it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
    ...
    const received = await supplyChain.receiveItem(upc, retailerID);
    ...
    assert.equal(received.logs[0].event, "Received", "Invalid event emitted");
  });
  ...
  it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async () => {
    ...
    const purchased = await supplyChain.purchaseItem(upc, consumerID);
    ...
    assert.equal(purchased.logs[0].event, "Purchased", "Invalid event emitted");
  });
